...
class Admin_EditionController extends Zend_Controller_Action
{
    ...
    public function init()
    {
        ...
        $this->workMapper = new Ruth_Collection_WorkMapper($this->db);
        $this->editorMapper = new Ruth_Collection_EditorMapper($this->db);
        $this->editionMapper = new Ruth_Collection_EditionMapper($this->db);
    }

   public function createAction()
    {
        // cria form
        $form = new Ruth_Form_EditionCreate;
        $this->view->form = $form;
    ...
    {
        $editorMapper = new Ruth_Collection_EditorMapper($this->db);
